...
describe('bikeFetch', () => {
  ...
  test('should return', () => {
    expect.assertions(1);
    return expect(api._test.bikeFetch('foo')).resolves.toMatchObject(stationData);
  });
});
...
describe('getStations', () => {
  test('should fetch', () => {
    expect.assertions(1);
    return expect(api._test.getStations()).resolves.toEqual(stationData.stations);
  });
...
describe('getAvailability', () => {
  test('should return map', () => {
    expect.assertions(1);
    return expect(api._test.getAvailability()).resolves.toEqual(expect.any(Map));
  });
});
